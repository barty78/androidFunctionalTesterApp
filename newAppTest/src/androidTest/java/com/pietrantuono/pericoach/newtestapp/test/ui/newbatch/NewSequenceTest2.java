package com.pietrantuono.pericoach.newtestapp.test.ui.newbatch;
...
import com.pietrantuono.pericoach.newtestapp.test.ui.classes.NewSequenceForTest;
...
public class NewSequenceTest2 extends ActivityInstrumentationTestCase2<MainActivity> {
	// private Job job;
	...
	public void setAllUp() throws ConnectionLostException, IOException{
		...
		NewSequenceInterface newSequence = new NewSequenceForTest(mainActivity, ioioMock);
		//newSequence.addTest(new DummyTest(mainActivity, "Dummy 1",false,true));
		//newSequence.addTest(new DummyTest(mainActivity, "Dummy 1",false,true));
