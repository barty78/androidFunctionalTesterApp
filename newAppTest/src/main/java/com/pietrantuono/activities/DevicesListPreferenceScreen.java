 ...
 */
public class DevicesListPreferenceScreen extends PreferenceGroup  {
    ...
    public DevicesListPreferenceScreen(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context=context;
    }

    public DevicesListPreferenceScreen(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected ListAdapter onCreateRootAdapter() {
        return new PreferenceGroupAdapter();
    }
    ...
    private class PreferenceGroupAdapter extends BaseAdapter{
        @Override
        public int getCount() {
            return 10;
        }
