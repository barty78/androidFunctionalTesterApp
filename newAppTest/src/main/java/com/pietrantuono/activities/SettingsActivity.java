...
public class SettingsActivity  extends PreferenceActivity {
    ...
    private void dowloadAll() {
        ...
        RecordsHelper recordsHelper=RecordsHelper.get(SettingsActivity.this);
        Cursor c=recordsHelper.getWritableDatabase().query(RecordsContract.TestRecords.TABLE,null,null,null,null,null,null);
        while (c.moveToNext()){
            TestRecord testRecord= new TestRecord();
            TestRecord record = new TestRecord();
            record.setBarcode(c.getLong(c.getColumnIndexOrThrow("Barcode")));
            record.setDuration(c.getString(c.getColumnIndexOrThrow( "Duration")));
            record.setFixtureNo(c.getString(c.getColumnIndexOrThrow("FixtureNo")));
            record.setFWVer(c.getLong(c.getColumnIndexOrThrow("JobNo")));
