...
public interface ErrorCodes {
    ...
    int SENSOR_TEST_NO_ACTIVITY_SET = 33;
    int SENSOR_TEST_NO_VOLTAGE_SET = 34;
    int SENSOR_TEST_SAMPLES_REF_NULL = 35;
    int SENSOR_TEST_LOAD_NULL = 36;
    int SENSOR_TEST_SENSOR_RESULT_NULL = 37;
    int SENSOR_TEST_INSUFFICIENT_SAMPLES = 38;
