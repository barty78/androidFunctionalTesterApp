...
public class MagnetWakeDevice extends ActivityInstrumentationTestCase2<MainActivity> {
	// private Job job;
	...
	public void setAllUp() throws ConnectionLostException, IOException{
		...
		when(ioioUtilsInterfaceMock.getUartLog()).thenReturn(new StringBuilder("foooo!!!"));
		...
		Test test=new MagnetWakeDeviceTest(mainActivity,ioioMock);
